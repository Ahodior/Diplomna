...
function ChapterWAIFU3() {
  return (
    ...
    <div className='chapterimgcon'>
      ...
      <Link to={'/chapterwaifu2'} className='chapterclic'>Назад</Link>
      <Link to={'/title20'} className='chapterclic'>Назад до тайтлу</Link>
      <Link to={'/title20'} className='chapterclic'>Далі</Link>
    </div>
    </div>
